...
export default class Basket{
    constructor() {
        ...
        this.url = 'https://raw.githubusercontent.com/AlinaNasibullina/static/master/JSON/basket.json',
        this._init()
        this.shown = false;
    }
    ...
    _init() {
        this._get(this.url)
            .then(basket => {
                ...
                //.map(p => new BasketProduct(p.productName, p.productPrice, p.productImg, p.productId, p.amount));
            })
            .finally(() => {
                this._render();
                this._handleActions();
...
class BasketProduct {
    ...
    render() {
        return `<div class="d-flex headerCartWrapIn mb-1 p-2 dropDown--product">
...
//     containerItems: null,
//     shown: false,
//     url: 'https://raw.githubusercontent.com/AlinaNasibullina/static/master/JSON/basket.json',
//     init() {
//         this.container = document.querySelector('#basket');
//         this.containerItems = document.querySelector('#basket-items');
//         this._get(this.url)
